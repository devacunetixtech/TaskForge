...
export default function DashboardPage() {
  ...
  const { data: balance, isLoading: balanceLoading } = useBalance({ address: visibleAddress, chainId: botchainMainnet.id });
